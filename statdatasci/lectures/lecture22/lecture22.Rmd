...
- Participation survey for last week and this week closes at 9PM
...
- If $n$ is large, CLT still holds, and using another theorem (out of scope for this class), we can prove that 
...
- The $t$ distribution has a parameter called **degrees of freedom**, abbreviated *df*. For each possible df, there is a different $t$ distribution, with the $t$ distribution looking more like the normal as $n$ gets large.
