...
- Hypothesis tests for population mean and proportion 
  ...
  - Inverting a confidence interval to get a hypothesis test

---
## Recall: Hypothesis Testing for the Population Mean
...
- The **test statistic** is $z$ (value on horizontal axis)
...
- Hypothesis tests for population mean and proportion 
  ...
  - Inverting a confidence interval to get a hypothesis test: reject $H_0$ if $\mu_0 \notin \left(\overline{X}-z_{\frac{\alpha}{2}}\frac{\sigma}{\sqrt{n}}, \overline{X}+z_{\frac{\alpha}{2}}\frac{\sigma}{\sqrt{n}} \right)$
