...
- Descriptive statistics do not necessarily generalize beyond the data 

- Can only be used to describe data set under study
...
- If the instructor takes another sample of 10 people from the class, would we expect the mean of this second sample to be equal to the mean of the first sample?
...
- Statistical inference relies on the assumption that the data are drawn or sampled from some larger population

- Allows us to draw conclusions about the larger population
...
- $P(A \cup {B^c}) = \frac{1792 + 7368 + 199 + 115 + 95+ 54 + 119}{10000} = .9875$
  - Or, $1 - \frac{143}{10000}$
