...
- Issues with Gradescope assignments

  - Select **all** corresponding pages 
  
  - Show **all code/plot outputs**
    
      - Do not just submit text file with R script
    
      - Print saved variables 

  - **Write answers in markdown portion of the file**, rather than code comments 
    
      - Break up long comments into multiple lines

- Anonymous mid-quarter survey on Canvas, closes on Friday
